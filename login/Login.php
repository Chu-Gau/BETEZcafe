                    ...
                    <nav class="navbar navbar-inverse">
                        <div class="container-fluid">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="maps.html">Địa điểm</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="icon-facebook">
                            <a href="https://www.facebook.com/dialog/oauth?client_id=536643483177466&redirect_uri=http://localhost/test/fblogin.php&scope=public_profile" target="blank">
